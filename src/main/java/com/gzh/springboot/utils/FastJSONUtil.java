...
public class FastJSONUtil {
	...
	public static String o2json(Object object) {
		if (null == object) {
			logger.error("json object is null ");
			return "";
		} else {
	...
	public static List<Object> parseJsonArray2List(String array) {
		if (StringUtils.isEmpty(array)) return null;
	...
	public static String getValByUniqueKey(String key, String jsonArray) {
		...
		for (Object obj : objs) {
			...
			if (StringUtils.isNotEmpty(val) && !val.equals("null") && !val.equals(""))
				break;
		}
		return val;
	}
	...
	public static List<Map<String, Object>> parseJsonArrayStrToListForMaps(String json) {
